...
def dashboard(request):
    ...
    for order_product in order_products :
        if order_product.product.category.category_name == 'Kitchen' :
            women += order_product.quantity
        elif order_product.product.category.category_name == 'Bathroom' :
            men += order_product.quantity
        elif order_product.product.category.category_name == 'Bedroom' :
            kids += order_product.quantity
        elif order_product.product.category.category_name == 'Living room' :
            cosmetics += order_product.quantity
        elif order_product.product.category.category_name == "Kid's furniture" :
    ...
    data4_label =['Kitchen','Bathroom', 'Bedroom', 'Living room', "Kid's furniture"]
